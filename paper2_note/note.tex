...
machine-checked in \texttt{RamaLean/HallCounterexample.lean}. The theorem of \cite{AFH} is
...
This is a decision procedure rather than a proof of the conjecture, and the distinction
matters. For a fixed graph the bound converges to the truth, so the procedure succeeds
whenever the conjecture holds with room to spare; proving Song--Fan--Miao for \emph{all}
biregular graphs would require $P_m$ bounded uniformly in the size of the graph, which is not
supplied here and is exactly what remains.
