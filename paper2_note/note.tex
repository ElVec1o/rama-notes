...
displacement vanishes, and the two ends are used equally. The lower bound also
appears to be sharp: the percentage rises with girth, reaching $98.6\%$ for the
Pappus graph, so no constant better than $2\sqrt m$ is available. Their roots do satisfy \eqref{eq:twosided}, with maxima
