...
reachable here is pre-asymptotic. Two residuals remain unexplained: the measured spread is about
three times the analytic one at comparable $n$, and the measured exponents sit about $0.088$
above the analytic quantile's. Both indicate that the finite-graph root distribution departs
from the tree measure near the edge by more than the quantile heuristic allows.
