...
$10^{-15}$. What remains open is a lower bound on $\Delta$ uniform enough to beat $m^{3/2}$,
which unlike its predecessors is a question about a Mahler measure, where coefficient bounds
are available and are not circular.
