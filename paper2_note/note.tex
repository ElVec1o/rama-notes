...
What is still missing is A10$'$ at intermediate $k$, where the children are not leaves and their
ratios must be controlled by a coupled induction across the bipartition. Lemma~\ref{lem:blocking}
supplies that induction's combinatorial input; assembling it is open.
