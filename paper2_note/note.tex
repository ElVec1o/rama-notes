...
For rank-$b$ orthogonal projections the statement survives. A search over more than
...
the smallest observed margin being $3.6\%$ of the band width. Two features make
...
Graphs are not always extremal there, however. At $(p,q,a,b)=(4,8,4,2)$ the minimum
of $E_4$ over projections is $400/3$ against $134$ over graphs, the gap appearing
exactly when $q>\binom pb$ forces every graph in the family to repeat a
neighbourhood and hence to contain a $4$-cycle. So the projection statement is
strictly stronger, though never by more than about $2.5\%$ of the margin in the
cases computed. A lower bound of the same shape is known in the random setting: Brito,
