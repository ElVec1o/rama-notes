...
coefficient formulas and the combinatorics behind the matching counts $m_2$, $m_3$
and $m_4$ are formalized in Lean~4; what is left by hand is the inclusion--exclusion
bookkeeping that assembles the last of these, and the numerical work.
\end{abstract}
...
recorded above. What is \emph{not} formalized is the inclusion--exclusion
arithmetic that sums the ten subgraph counts into $m_4$, and the numerical
verifications.
