...
$+0.093$, at $R^2>0.98$ in every family (\texttt{code/nobs.py}). Whether the departure survives
to infinity is still unknown, since everything at these sizes is pre-asymptotic, the analytic
quantile included.
