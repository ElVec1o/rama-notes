...
decides small cases outright and is too weak for large ones, which is the first positive
result on the conjecture since the counterexample and is stated as the partial result it is.
