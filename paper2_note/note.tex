...
The within-group spreads are far below the between-group gaps, and refitting on the upper half
of each range shows no drift toward a common value, so the dependence is real. The value $-2/3$
is right for $q=2d$ and wrong elsewhere. The constant behaves the same way: with the exponent
...
The limits are the obvious ones. The fits reach $n=90$; the identification of any particular
