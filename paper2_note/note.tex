...
The remaining gap is exactly the hypothesis $k>\lambda B$ of (ii). A degree-$q$ path-tree vertex
has $q$ children minus those neighbours already lying on the path, so what is needed is a lower
bound on unblocked neighbours at high-degree vertices of the path tree. That is a combinatorial
statement about self-avoiding walks, not a spectral one, which is the point of taking this
route; it is open.
