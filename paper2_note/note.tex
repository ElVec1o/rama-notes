...
$(a,b)$-biregular one, which is Problem~1 of Song, Fan and Miao and is untouched by every
counterexample here: all of them have at least three distinct degrees. That, together with
the first Betti number one case where the conjecture is a theorem, is where the remaining
interest lies.
