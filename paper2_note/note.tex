...
Theorem~\ref{thm:subdiv} settles the case $r=2$ of Problem~1 of \cite{SFM}.
...
Ramanujan $2$-covering. The case $r\ge3$ of their problem remains open, as does
Conjecture~\ref{conj:gap} for $b\ge3$.
...
$(a,b)$-biregular graph with $a,b\ge2$ is at most $s+t$ \cite{XZ}. It is worth
...
of $f_G$, so is the other. The upper bound is furnished by the path tree, which
is finite, and a finite subtree of the $(a,b)$-biregular tree has spectral
radius strictly less than $s+t$. Hence $(s+t)^2$ is not a root, and therefore
neither is $(s-t)^2$.
\end{proof}
...
\bibitem{XZ} Z.~Xu, P.~Zhang, \emph{An improved upper bound for the
Bilu--Linial conjecture via interlacing families}, arXiv:2606.28797 (2026).
