...
assumed. What remains carried as a hypothesis is \texttt{htight}, that
$\operatorname{Adj}(A)=aI$ forces $\sum_k\iota_{f_k}\omega_k'=0$; that is the polarization
step, and it is the only unformalized input to Theorems~\ref{thm:C2} and~\ref{thm:Cr}.
