...
$2\cos(4\pi/9)=0.3473$ inside that gap. So the $d=1$ case of
Conjecture~\ref{conj:gap} does not follow from the path-tree argument, and we
have tested it separately on the subdivisions of $K_4$, $K_{3,3}$, the prism,
$Q_3$, the Wagner graph and the Petersen graph --- all of which have
$(3,2)$-biregular universal cover --- with smallest root ratios
$1.97,\,1.69,\,1.72,\,1.57,\,1.56,\,1.47$ and no root in the gap; the
subdivisions of the Heawood and M\"obius--Kantor graphs, of girth $6$, give
$1.36$ and $1.33$. The ratios decrease as the girth grows, as they must if the
containment is sharp, but the decrements shrink and no computation crosses $1$.
