...
positive quantity. That is a genuine weakening of the target, and it is the only one we
have found. It does not close the problem --- no upper bound on $X_e$ is available at all
--- but it changes what one must prove. On the graphs tested $(\mathrm H)$ held with
margin $0.52$ to $0.71$, and the sufficient condition held with the right-hand side
exceeding $|X_e|$ by a factor of five to twenty.
...
Proposition~\ref{prop:rigid}; and \texttt{cavity\_step\_deficient} is
Proposition~\ref{prop:defstep}, the strengthened step. Proposition~\ref{prop:deficient} is
