...
The dimension restriction is therefore an artefact of stopping at two moments rather than
something intrinsic, and what would remove it at a stroke is an a priori bound
$p_k\le(m/2)W_{2k}$ for the plane class, with $W_{2k}$ the tree walk count; for graphs that is
Godsil's path-tree argument, the path tree being a subtree of the universal cover, and for
noncommuting plane families it is open.
