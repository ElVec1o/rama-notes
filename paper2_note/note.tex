...
This is the first proof of the inner end of \eqref{eq:twosided} for a nontrivial class. The
invariant is measured to hold outside the range too, so the bound remains lossy for $(3,6,5)$.
