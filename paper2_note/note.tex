...
Graphs are not always extremal there, however, and the smallest case can be settled
exactly. Take $b=2$, $p=4$, so $q=2a$ and $\sum_kP_k=aI_4$. Writing
...
=2\sum_{r<s}\lambda_r\lambda_s\ge0$.
