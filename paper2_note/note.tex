...
That preprint has remained unrefereed since 2018 --- it carries no journal reference or
DOI as of August 2026 --- and the reason is not mathematical. Chris Hall, who posed the
...
the matching polynomial, and for $a$-regular graphs of growing girth its root measure
converges to the Kesten--McKay measure, whose Stieltjes transform is
$G(z)=2(a-1)/\bigl((a-2)z+a\sqrt{z^2-4(a-1)}\bigr)$. At $z=2\sqrt a$ the radical is
\emph{exactly} $2$, and everything collapses:
...
which is Theorem~\ref{thm:matchingform}, and the Kesten--McKay limit, which is cited. The vertex recursion of Theorem~\ref{thm:vertexrec} and the
