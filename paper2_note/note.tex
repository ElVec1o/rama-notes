...
the reflection, so at $b=2$ the open lower bound is \emph{equivalent} to the known
upper bound. For diagonal families this is Theorem~\ref{thm:subdiv} again: there
