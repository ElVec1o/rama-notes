...
reduced to a spectral bound on the child's vertex matrix. We have not proved that bound.
...
Proposition~\ref{prop:defstep}, the strengthened step; and \texttt{compression\_sum},
\texttt{trace\_le\_of\_rayleigh} and \texttt{remainder\_upper} are
Proposition~\ref{prop:twolevel}. Proposition~\ref{prop:deficient} is
