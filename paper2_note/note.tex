...
f_l\wedge\omega'_{T\setminus l}\rangle$ were nonnegative in every family tested. That
nonnegativity is not termwise, and it is worth recording that it is not, since the
termwise statement is the natural thing to try and it is false: single pairs $(k,l)$
...
$T$ of a given size, not about its terms. Finally
$X_e=\sum_{r\ge2}(-1)^{r-1}C_rx^{\,m-2r}$ was negative at $x=2\sqrt a$ in every case,
including under direct maximization over the sphere of directions; the identity of
Theorem~\ref{thm:vertexrec} was checked to $10^{-13}$ on graph, projection and
general weighted plane families at generic directions
...
\texttt{weak\_beats\_ab}). \texttt{RamaLean/VertexSplit.lean} carries the Gram form of
