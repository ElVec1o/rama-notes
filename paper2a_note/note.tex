...
The conclusion is narrower than "the evidence is worthless" and sharper than "the threshold did no
harm". The sweeps we ran are unaffected. But any search for a \emph{new} counterexample at threshold
$0.05$ is looking outside the region where all five known examples live, and would have rejected
Hall's. The four above have minimum degree one, so they bear on Conjecture~\ref{conj:gap} and not on
Conjectures~\ref{conj:mindeg3} or \ref{conj:c2}, which remain open.
