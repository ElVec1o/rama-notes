...
containment is measured for biregular families, but at minimum degree three in general it is not
established and a candidate failure has been found, so it may well be false exactly where
Conjecture~\ref{conj:mindeg3} is true; the companion paper \cite{PartII} records the state. We
mention the reduction because the implication holds regardless, not because it is a route we can
presently recommend.
...
The counterexample refutes more than the conjecture it was built for. Zili Xu (personal
communication, August 2026) proposes a spectral-inclusion conjecture for \emph{additive products}
...
His own remark supplies the refutation. Taking the atoms to be the individual edge-adjacency
