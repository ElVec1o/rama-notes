...
\subsection{The origin: Hall's condition exactly}\label{sec:hallzero}

Proposition~\ref{prop:degbound} needs $\theta\ne0$, because the step $s\ge2c$ used that no
component of $G[S]$ is a single vertex. The excluded case is not a loose end. It has a complete and
entirely elementary answer, which we record because it identifies the point spectrum at the origin
with a classical condition.

\begin{theorem}\label{thm:hallzero}
...
The counting step is machine-checked in \texttt{RamaLean/HallZero.lean} as
