...
decays like $n^{-2/3}$, the soft-edge exponent \cite{PartII}. Two families, two different exponents,
both tending to zero. If Conjecture~\ref{conj:mindeg3} is true it is true tightly, and an argument
yielding a margin bounded below independently of size cannot prove it, for the reason the companion
paper gives in the biregular case.
