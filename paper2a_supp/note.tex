...
\textbf{Read the whole of this section under the caveat of \cite{PartI}, \S\ref{sec:blindspot}:}
every search below filters gaps by a minimum width of $0.05$, and Hall's own counterexample sits in
a gap of width $0.040$, so the instrument used for these searches would have scored his graph clean.
The scale of the searches is real; their evidential weight is not what it appears.
...
\section{Corollaries of the closed form, and the separation mechanism}
