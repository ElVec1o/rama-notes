...
\texttt{tangentConeAt}. \texttt{RamaLean/OrderFourSolvable.lean} is the step joining
...
mixed discriminant. What is cited and not formalised is stated in each file: the implicit function
theorem step of Proposition~\ref{prop:tworeg}, and Aleksandrov's, Bapat's and Gurvits' theorems.
