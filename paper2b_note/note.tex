...
This is computational evidence and is labelled as such: the form was built numerically, and
upgrading it would mean recomputing the $63\times63$ matrix in exact arithmetic, which the
machinery of \texttt{code/curvature.py} does for one direction at a time.
