...
\item No bound of the form $\operatorname{maxroot}\mu\le F(a,b,p,q,\operatorname{spec}A_1,\dots,
  ...
  the sign is also checked along curves whose second-order term is perturbed inside the kernel, and
  it survives (\texttt{code/quartic.py}). Since $\Gamma$ is normalised to $1$ on these directions the
