...
family and only the constant differs. The obstructed configuration asks only for two hyperedges
sharing $w$ and both missing $v$, which exists in any commuting tight family with $a\ge2$ and
enough vertices; that says when the direction exists, not that it is always obstructed, and two
families measured is what is in hand.
