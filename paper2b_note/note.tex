...
By Theorem~\cite{HallCE} the implication now runs the other way and
...
What survives all three is the ratio recursion, which bounds ratios of matching polynomials rather
than Rayleigh quotients, and that is where we would put further effort. The remaining gap is
