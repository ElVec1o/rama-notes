...
So the inequality Xu conjectures is a theorem on the coordinate locus, at every rank, and not only
...
conjecture lies off the coordinate locus: the bridge of Proposition~\ref{prop:bridge} fails for
