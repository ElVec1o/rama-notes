...
\item No bound of the form $\operatorname{maxroot}\mu\le F(a,b,p,q,\operatorname{spec}A_1,\dots,
  ...
  edge, which is the statement to be proved. This is why the barrier route yields no reduction, and
  it applies equally to the Poisson-binomial variance of \S\ref{sec:rank}, which is a spectral
  functional and is constant at $(b/a)(1-1/a)$ on the class. A proof must read a joint invariant of
  ...
  (\texttt{code/jointinv.py}). That is a correlation on random families and not a theorem.
